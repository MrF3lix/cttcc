        ...
        <div className="pt-8 pb-4">
            <div className="relative">
                ...
                <div className="relative flex justify-center">
                    ...
                    >
                        {state && <MinusSmIcon className="-ml-1.5 mr-1 h-5 w-5 text-gray-400" aria-hidden="true"/>}
                        {!state && <PlusSmIcon className="-ml-1.5 mr-1 h-5 w-5 text-gray-400" aria-hidden="true"/>}
                        <span>Duty Cycle Inputs</span>
                    </button>
                </div>
            </div>
        </div>
